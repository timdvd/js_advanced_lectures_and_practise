...
// Cards classes
    class MenuCard{
        constructor(src, alt, title, desc, price, parentSelect, ...classes){
            this.src = src;
            this.alt = alt;
            this.title = title;
            this.desc = desc;
...
function forms(formSelector, modalTimerId){
    ...
    const message = {
        loading: 'spinner.svg',
        success: 'Спасибо! Скоро мы вам отпишем',
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2025-07-30');
